...
public abstract class StringUtils {
	 ...
	 * @return
	 */
	public static String delete(String inString,Integer pos) {
	 ...
	 * @return
	 */
	public static String delete(String inString,Set<Integer> posSet) {
		if(inString == null || "".equals(inString)){
			return "";
		}
		StringBuffer sbuf = new StringBuffer();
	 ...
	 * @return
	 */
	public static String deleteStart(String inString) {
	 ...
	 * @return
	 */
	public static String deleteEnd(String inString) {
	 ...
	 * 字符串字符替代
	 * @param inString 字符串
	 * @param oldPattern 被替换的字符
	 * @param newPattern 替换字符
	 * @return
	 */
